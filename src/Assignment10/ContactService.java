...
public class ContactService {
	...
	ContactService()throws Exception
	{
		...
		con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","root","anirudha");
	}
	...
	{
		PreparedStatement ps=con.prepareStatement("select cid from dhaval_contacts");
	...
	public void insertContactInDB()												
	{
		try
		{
			PreparedStatement ps=con.prepareStatement("INSERT INTO Dhaval_Contacts VALUES (?,?,?,?)");
	...
	{
		File f=new File("C:\\Dhaval_Persistent_Internship\\Core_Java\\Contacts.txt");
		//if(f.exists())
	...
	public Set<Contact> populateContactFromDB()throws Exception
	{
		...
		PreparedStatement ps=con.prepareStatement("select * from dhaval_contacts");
		ResultSet rs=ps.executeQuery();
